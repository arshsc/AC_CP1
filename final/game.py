        ...
        while True:
            ...
            if search == "bathroom":
                if bathroom_searched == False:
                    ...
                    print("\nYou already searched the bathroom, nothing else is to be found.")
                    break
            ...
            elif search == "main_area":
                if main_area_searched == False:
                    bathroom_note = input("\nYou look around your surroundings. On the small dining table there is a note. Would you like to read it?\n-Yes\n-No\n").strip().lower()
                    while True:
                        if bathroom_note == "yes":
                            print("\n\"WHAT NOTE SAYS!\"")
                            break
                        elif bathroom_note == "no":
